	...
	return (
		<div className='bg-gray-300 py-1 overflow-hidden w-full'>
			<div className='w-auto grid grid-flow-col'>
				<div className='w-screen hidden md:grid grid-cols-10 gap-2 p-1 animate-infinite-carousel'>
					<img
						className='rounded object-contain shadow-md shadow-black/50 h-12 w-full bg-white'
						src='/images/10.png'
						alt=''
					/>
					<img
