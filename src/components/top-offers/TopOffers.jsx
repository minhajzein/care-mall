function TopOffers() {
	return (
		<div className='flex flex-col mt-4 gap-4'>
			...
			<div className='grid px-4 grid-cols-2 md:grid-cols-4 gap-4'>
				<div className='flex flex-col bg-gray-400 rounded-lg overflow-hidden'>
					<div className='flex justify-between items-start p-2 md:p-4 bg-primary rounded-lg'>
						<h1 className='text-md md:text-2xl uppercase leading-5 md:leading-8 text-white font-bold'>
							deal of <br />
							the week
						</h1>
						<img src='/svgs/care-logo.svg' className='md:size-10' alt='' />
					</div>
					<p className='md:text-xs text-[12px] p-1'>view all offers</p>
				</div>
				<div className='flex flex-col bg-gray-400 rounded-lg overflow-hidden'>
					<div className='flex justify-between items-start p-2 md:p-4 bg-primary rounded-lg'>
						<h1 className='text-md md:text-2xl uppercase leading-5 md:leading-8 text-white font-bold'>
